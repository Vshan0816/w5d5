...
def harrison_ford
  ...
  # as a lead actor.
  # Actor.joins(:movies).where("actors.name = 'Harrison Ford' AND castings.ord > 1").select('movies.id, movies.title')
...
def biggest_cast
  ...
  # actors).
  # how do you find the largest cast? 
  # group by movie
  # each movie should have a seperate actor.id
  # limit 3, descending
